...
export const addLocation = (location) => {
    return async dispatch => {
        const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${location.lat},${location.lng}&language=en&key=AIzaSyANv-6zqK0wzXkwJa2iwQJOXkdGT8IDMec`);
        if(!response.ok){
